...
// GiftModal Component (moved here for self-containment)
            ...
            <div className="bg-gray-800 rounded-xl shadow-2xl p-6 w-full max-w-sm md:max-w-md lg:max-w-lg relative border border-gray-700">
                ...
                <div className="flex flex-col items-center mb-4">
                    <img 
                        ...
                        onError={(e) => { e.target.onerror = null; e.target.src = `https://placehold.co/64x64/333333/FFFFFF?text=${symbol.toUpperCase()}`; }}
                    />
...
// BubbleCanvas Component (moved here for self-containment)
const BubbleCanvas = ({ cryptoData, loading, selectedCryptos, sortMethod, onBubbleClick }) => {
    ...
    const bubblesGroup = useRef(new THREE.Group()); // Group to hold all bubbles

    const bubbleMeshes = useRef([]); // Store references to actual THREE.Mesh objects
...
const App = () => {
    ...
    // New state for selected timeframe
    ...
    // New handler for timeframe buttons
